package com.bhopalepooja862.LearningRESTAPIs.service.impl;

import com.bhopalepooja862.LearningRESTAPIs.dto.StudentDto;
import com.bhopalepooja862.LearningRESTAPIs.entity.Student;
import com.bhopalepooja862.LearningRESTAPIs.repository.StudentRepository;
...
public class StudentServiceImpl implements StudentService {
    ...
    public StudentDto getStudentById(Long id) {
        Student student = studentRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("Student not found id " + id));
    ...
    public StudentDto updateStudent(Long id, AddStudentRequestDto addStudentRequestDto) {
        Student student =studentRepository.findById ( id)
                .orElseThrow(()-> new IllegalArgumentException("Student not Found of this ID:" +id));
